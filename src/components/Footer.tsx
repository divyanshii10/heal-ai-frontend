        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-white">heal.ai</span>
            </div>
            <p className="text-sm text-gray-400">
              Your trusted companion for health insights and support. We're here to help you make informed decisions about your wellbeing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { to: '/symptoms', text: 'Symptoms Analysis' },
                { to: '/features', text: 'Our Features' },
                { to: '/image-analysis', text: 'Image Analysis' },
                { to: '/faq', text: 'FAQ' },
              ].map((link) => (
                <li key={link.to}>
                  <Link 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin size={20} className="text-teal-500 mt-1 mr-3 flex-shrink-0" />
                <span className="text-gray-400">123 Health Street, Medical District, Example City, 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">support@heal.ai.example</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input 
                ...
                className="px-4 py-2 bg-gray-800 text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
              <button 
                type="submit" 
